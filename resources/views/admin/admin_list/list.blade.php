        ...
        <div class="card">
            <div class="card-header">
                <div class="mb-2">
                    <div class="row">
                        <div class="col-md-8">
                            <h5 class="mb-0">Reseller List</h5>
                        </div>
                        <div class="col-md-4 text-end">
                            
                            <a href="{{URL::to('admin/add_admin_user')}}" class="btn btn-info"> <i class="fa fa-plus" aria-hidden="true"></i> Reseller</a>
                           
                            <a href="{{URL::to('admin/expiry_resaller_user')}}" class="btn btn-success"> <i class="fa fa-plus" aria-hidden="true"></i> Expired Reseller</a>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row my-4">
                    ...
                    <div class="col-md-8 text-center">
                        <h4 class="">Search</h4>
                        <form action="{{URL::to('admin/admin_list')}}" method="post">
                            @csrf
            ...
            <form action="{{URL::to('admin/downloadadminPdf')}}" method="post">
                @csrf
                    <div class="row my-3">
                        <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                @foreach ($user as $key=> $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{URL::to('admin/dashboard_visit/'.$item->id)}}"><i class="fas fa-eye"></i>Dashboard Visit</a>
                                            <a href="{{URL::to('admin/edit_admin/'.$item->id)}}"><i class="fas fa-edit"></i></a>
                                            <a href="{{URL::to('admin/delete_admin/'.$item->id)}}" onclick="dataDelete(event)"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <!-- end row --> 
                                @endforeach
