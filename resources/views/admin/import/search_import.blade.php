              ...
              <div class="col-md-3">
                ...
                <div class="col-sm-12">
                  <select class="form-select" name="search_type" aria-label="Default select example">
                    ...
                    <option value="bill_of_entry_n__and_date"  @if(isset($_GET['search_type']) && $_GET['search_type'] == 'bill_of_entry_n__and_date') selected @endif >B/E No</option>
                    ...
                    <option value="bl_no_and_date"  @if(isset($_GET['search_type']) && $_GET['search_type'] == 'bl_no_and_date') selected @endif >B/L No</option>
                  ...
                  @if (count($imports) > 0)
                    @foreach ($imports as $key=> $item)
                      <tr>
                        ...
                        <td>{{$item->job_no}}</td>
                        <td>{{$item->bill_no}}</td>
                        <td>{{$item->total_sale_bill_amount}}</td>
                        ...
                        <td><a href="{{URL::to('admin/edit_inport_form/'.$item->id)}}">Edit</a></td>
                      </tr>
                    @endforeach
                  @endif
