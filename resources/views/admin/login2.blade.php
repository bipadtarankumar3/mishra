...
<body>
  ...
  <main class="sign_inout_pagee" style="background: url({{asset('adminAssets/new_admin/assets/img/transport.jpg')}}) no-repeat center center;background-size: cover;">
     <div class="container">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form  method="POST" action="{{URL::to('login_post')}}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-md-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="email" class="form-control" placeholder="Type Your ID" id="ID" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" placeholder="Type Your Password" id="yourPassword" required>
