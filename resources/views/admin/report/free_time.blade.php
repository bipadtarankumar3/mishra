                        ...
                        @endphp 
                          ...
                          <td> 
                            @php
                                ...
                                if ($existingDate = $item->job_completion_date == '') {

                                  $date1_str = $item->job_created_dt;
                                  $date2_str = $item->free_time_till_date;
                                  
                                  // $date1_str = '2024-03-03';
                                  // $date2_str = '2024-02-20';

                                  // Convert strings to DateTime objects
                                  $date1 = new DateTime($date1_str);
                                  $date2 = new DateTime($date2_str);

                                  // Get the day of the week for each date (in number format)
                                  $day_of_week_date1 = $date1->format('N');
                                  $day_of_week_date2 = $date2->format('N');
